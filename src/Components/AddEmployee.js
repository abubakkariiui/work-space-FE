...
function AddEmployee({ match }) {
    ...
    const getEmployee = (employeeId) => {
        getSingleEmployee(employeeId).then(res => {
            const { firstName, lastName, department } = res;
    ...
    const saveEmployee = (e) => {
        ...
        if (employeeId) {
            ...
            updateEmployee(employeeId, employee).then(res => {
                navigate('/employees')
                        ...
                        employeeId && (
                            <div className='form-group'>
                                ...
                                <select
                                    className='form-control'
                                    value={taskIds.join(',')}
                                    onChange={(e) => setTaskIds(Array.from(e.target.selectedOptions, option => option.value))}
                                >
